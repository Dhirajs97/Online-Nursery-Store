...
<html>
<head>
<title>Online Nursery Store</title>
<meta charset="utf-8">
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    <div id="logo" class="fl_left">
       <div style="float:left; margin-top:-11px;"><h1 style="font-size:36px;"><a href="index.jsp">Online Nursery Store</a></h1>
    ...
    <nav id="mainav" class="clear"> 
      <ul class="clear">
		...
		<% if(session.getAttribute("login_level") == null) { %>
			<li><a href="list-product.jsp?type_id=0">All Plants</a></li>
